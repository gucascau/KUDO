...
```{r}
setwd(
  "/home/gdbecknelllab/xxw004/gdjacksonlab/UUO/Results/UroBladderOrganoid/"
)
Indir <-
  c(
    "/home/gdbecknelllab/xxw004/gdjacksonlab/UUO/Datasets/UrotheiumOrganoid/GSE131909_RAW/"
  )
Outdir <-
  c(
    "/home/gdbecknelllab/xxw004/gdjacksonlab/UUO/Results/UroBladderOrganoid/"
...
scrna@meta.data$DataSet <-
  ordered(factor(scrna@meta.data$DataSet),
          levels = c("GSM3827176_NMU_O_D", "GSM3827175_NMU_O_P"))
...
pdf("UroBladderOrganoid_mtPercent.pdf", height = 4, width = 6)
...
saveRDS(scrna, file = "UroBladderOrganoid_scrna_merged_withdoublets.rds")
# remove the doublets
...
#saveRDS(scrna, file = "UroBladderOrganoid_scrna_merged_withoutdoublets.rds")
...
ggsave(filename = "UroBladderOrganoid_SampleQC_reports.pdf",plot = VQCReport, height = 12, width = 4 )
```
```{r}

IntegratedDir<- paste0(Outdir, "IntegratedUroBladder/")
...
saveRDS(scrna, file = "UroBladderOrganoid_singlecell_doublet_harmony_v0618.RDS")

#scrna<- readRDS("UroBladderOrganoid_singlecell_doublet_harmony_v0618.RDS")
...
# check the expression of these markers in the UroBladderOrganoid

# the average expression of these markers in the UroBladderOrganoid
...
ggsave("KidneyMarkersDotPlot_UroBladderOrganoid_Reclustered.pdf", plot=KidneyMarkersDotPlot, height=4, width=20)
